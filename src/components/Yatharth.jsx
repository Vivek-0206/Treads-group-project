			...
			<Col xs={3} md={2} className="sidebar bg-dark" style={{ minHeight: '80vh' }}>
				<ul className="nav flex-column">
					<li className="nav-item">
						<NavLink to="/yatharth" className="nav-link text-white" activeClassName="active">
							About
						</NavLink>
					</li>
					<li className="nav-item">
						<NavLink to="/yatharth/projects" className="nav-link text-white" activeClassName="active">
							Projects
						</NavLink>
					</li>
					<li className="nav-item">
						<NavLink to="/yatharth/blog" className="nav-link text-white" activeClassName="active">
							Blog
						</NavLink>
					</li>
					<li className="nav-item">
						<NavLink to="/yatharth/contact" className="nav-link text-white" activeClassName="active">
							Contact
						</NavLink>
					</li>
				</ul>
